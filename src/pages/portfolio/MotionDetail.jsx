          ...
          <div className="bg-gray-100 rounded-2xl p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="flex items-center gap-3 p-3 border-b border-gray-100 text-gray-500">
                <img
                  src="/VecVisuals/assets/animation/Dashbord.png"
                  alt="Dashbord"
              ...
              <div className="flex items-center gap-3 p-3 border-b border-gray-100 text-gray-500">
                <img
                  src="/VecVisuals/assets/animation/Project.png"
                  alt="Project"
                  className="h-6 w-6 object-contain flex-shrink-0"
                />
          ...
          <div className="bg-gray-100 rounded-2xl p-6">
            <h4 className="text-sm font-semibold text-gray-700 mb-4">
              ...
              <div className="flex items-center justify-around gap-2 pt-2 border-t border-gray-100">
                ...
                <img
                  src="/VecVisuals/assets/animation/Camera.png"
                  alt="Camera"
                  className="h-6 w-6 object-contain flex-shrink-0"
                />
                
                <img
                  src="/VecVisuals/assets/animation/Gallery.png"
                  alt="Gallery"
                  className="h-6 w-6 object-contain flex-shrink-0"
                />

                <img
                  src="/VecVisuals/assets/animation/Settings.png"
                  alt="Settings"
                  className="h-6 w-6 object-contain flex-shrink-0"
                />
